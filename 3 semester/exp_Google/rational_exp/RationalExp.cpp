...
////	register int max_size = addends.capacity - max(size, addends.size) - 1;
...
//
//BigInt BigInt::operator+(const BigInt& addends) {
//	BigInt temp(*this);
//	return temp += addends;
//}
//const BigInt& BigInt::operator+=(const BigInt& addends) {
//	register int carry = 0;
...
//}
//const BigInt& BigInt::operator-=(const BigInt& subtrahend) {
//	register int carry = 0;
//	register long long temp = 0;
//	register int max_size = subtrahend.capacity - max(size, subtrahend.size) - 1;
//
...
//	return temp /= divisor;
//}
//const BigInt& BigInt::operator/=(const BigInt& denom) {
//	BigInt irrational(0, (capacity << 1));
//
...
//		}
//	
//	return BigInt(irrational);
//}
//
//
//BigInt BigInt::operator*(const unsigned int& multiplier) {
//	BigInt temp(*this);
//	return temp *= multiplier;
//}
//const BigInt& BigInt::operator*=(const unsigned int& multiplier) {
//	register int carry = 0;
//	register int max_size = capacity - size - 1;
//	if (max_size < 0) max_size = 0;
//
...
//		if (number[index] > B.number[index]) return false;
//	return true;
//}
//
//bool BigInt::operator<=(const BigInt& B) const {
...
//
//	for (index; index < capacity; index++) {
//		if (number[index] < B.number[index]) return true;
//		else if (equal && number[index] != B.number[index]) equal = false;
//	}
//	return equal;
//}
//
...
//	out << "2 + (" << *R.numer << ") / (" << *R.denom << ")";
//	return out;
//}
//
//
//void RationalExp::get_irrational() {
//	if (irrational) delete irrational;
//	irrational = new BigInt(*numer / *denom);
//}
//
//void RationalExp::output_irrational(std::ostream& out) {
//	if (irrational == nullptr) get_irrational();
//
//	out << "2." << irrational->number[0];
//	out.width(ORDER_OF_BASE);
//	out.fill('0');
